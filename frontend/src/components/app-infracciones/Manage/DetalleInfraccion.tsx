...
const InformacionExpediente = lazy(
  () => import("../Stages/InformacionInfraccion"),
);
const Respuesta = lazy(() => import("../Stages/Respuesta"));
const Visita = lazy(() => import("../Stages/Visita"));
const Concepto = lazy(() => import("../Stages/Concepto"));
const Seguimiento = lazy(() => import("../Stages/Seguimiento"));
const Cierre = lazy(() => import("../Stages/Cierre"));
...
export default function DetalleInfraccion({
  ...
  // Sincronizar cuando cambia el expediente desde el padre
  useEffect(() => {
      ...
      try {
        ...
        if (response.ok && response.data) {
          ...
          const expedienteDetalle: ExpedienteDetalle = {
            ...
            causa: information.causa || { id: 0, nombre: "Sin causa" },
  ...
  // Función para actualizar el expediente
  ...
  const handleDownloadAll = async () => {
    ...
    const url = `${BASE_URL}${API_CONFIG.ENDPOINTS.INFRACTION_DOWNLOAD_ALL(
  ...
  const renderTabContent = () => {
    ...
    const commonProps = {
      ...
      expediente_id: expedienteDetalle.id,
