...
type Props = {
  involucrado: { nombre: string; tipo_documento: string; numero_documento: number };
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
};
          ...
          <div className="flex items-start gap-4 mb-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-base-content/80 text-sm leading-relaxed">
                ...
                <span className="font-semibold">{involucrado.nombre}</span>{" "}
                {involucrado.tipo_documento}: {involucrado.numero_documento} del expediente?
              </p>
