...
import DataStageExecution from "./EjecucionSancion/EjecucionSancionData";
import ConfirmArchiveModal from "./EjecucionSancion/ConfirmArchiveModal";
...
export default function EjecucionSancion({
  ...
  const fetchExecution = useCallback(async () => {
    ...
    try {
      ...
      const res = await apiCall(
        API_CONFIG.ENDPOINTS.FILE_EXECUTION(expedienteId),
        {
          method: "GET",
        },
      );
  ...
  const creable = localCreable ?? localExecution?.creable ?? { status: true, msg: "" };
  ...
  const handleArchiveConfirm = async () => {
    ...
    try {
      ...
      const res = await apiCall(
        API_CONFIG.ENDPOINTS.FILE_ARCHIVE(expedienteId),
        {
          method: "PATCH",
        },
      );
    ...
    return (
      <div className="space-y-6">
        <DataStageExecution
          ...
          tipoEtapa="etapa_ejecucion_sancion"
