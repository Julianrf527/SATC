...
import InformacionBasicaExpediente from "./Information/InformacionExpediente";
import InvolucradoExpediente from "../../app-involved/Common/InvolucradosExpediente";
import AlertasExpediente from "./Information/AlertasExpediente";
...
export default function InformationExpediente({
  expediente,
  municipioList = [],
  recursoAfectadoList = [],
      ...
      <div className="w-full">
        <InvolucradoExpediente
          ...
          endpoints={{
            ...
            desvincular: (id) => API_CONFIG.ENDPOINTS.FILE_INVOLVED_UNLINK(id),
          }}
          setToast={setToast}
          isEditable={isEditable}
        />
