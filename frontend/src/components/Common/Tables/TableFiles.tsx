...
export default function TableFiles({
  ...
  const allSelected = data.length > 0 && data.every((f) => selectedIds.has(f.id));
            ...
            {loading ? (
              ...
              data.map((f) => (
                <tr
                  ...
                  onClick={() => onSelectionChange(f.id, !selectedIds.has(f.id))}
                >
                  <td onClick={(e) => e.stopPropagation()}>
                    <input
                      ...
                      onChange={(e) => onSelectionChange(f.id, e.target.checked)}
                    />
                  </td>
