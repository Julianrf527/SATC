...
export default function Slider({ permission }: Props) {
  ...
  return (
    <div className="drawer-side transition-all duration-200 z-[9999]">
      <label htmlFor="my-drawer" className="drawer-overlay"></label>
      <div className="bg-base-100 text-base-content h-full w-72 shadow-xl border-r border-base-300">
        {/* Header del menú */}
