...
class EtapaInicioSancionatorio(Base):
    __tablename__ = 'etapa_inicio_sancionatorio'
    ...
    expediente = relationship("Expediente", back_populates="etapa_inicio_sancionatorio")
