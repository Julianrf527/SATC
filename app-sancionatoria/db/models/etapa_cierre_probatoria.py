...
class EtapaCierreProbatoria(Base):
    __tablename__ = 'etapa_cierre_probatoria'
    ...
    expediente = relationship("Expediente", back_populates="etapa_cierre_probatoria")
    acto_administrativo = relationship("ActoAdministrativo", foreign_keys=[acto_administrativo_id])
    anexos = relationship("DocumentoAnexo", primaryjoin="and_(DocumentoAnexo.etapa_tipo=='cierre_probatoria', foreign(DocumentoAnexo.etapa_ref_id)==EtapaCierreProbatoria.id)", viewonly=True)
